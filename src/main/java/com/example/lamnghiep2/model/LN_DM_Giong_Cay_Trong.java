...
@Entity
@Table(name = "LN_DM_Giong_Cay_Trong")
public class LN_DM_Giong_Cay_Trong {
    @Id
    ...
    public LN_DM_Giong_Cay_Trong(int id, String code, String name, String description, boolean is_active, boolean is_delete, String create_user, String create_username, Timestamp create_date, Timestamp update_date, String update_user, String update_username, String delete_user, String delete_username, String uid) {
        this.id = id;
        this.code = code;
        this.name = name;
        this.description = description;
